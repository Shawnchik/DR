def ctrl_scp234():
    ...
    # 冷暖房時冷水一次ポンプ、弁制御。蓄熱時と非蓄熱時との2パターンでポンプINVや弁開度を計算する。
    # Nomenclature
    ...
    global KpINVSCP2,TiINVSCP2,KpINVSCP3,TiINVSCP3
    ...
    global SpGSCP2,SpGSCP3
    global FlgPIDINVSCP2,FlgPIDINVSCP3,FlgPIDINVSCP4,FlgPIDVlvCh1CHEX,FlgPIDVlvSCP4
    global day,hour
    global MvGCh2CHEX
    global PFINVSCP2,PFINVSCP3,PFVlvCh1CHEX
    # 冷水
    # 蓄熱・追掛時
    ...
    # 蓄熱時,追掛時
    if SgChSt == 1 or SgChSt == 2:
        if MvGCh2CHEX > 0.5 and FlgFlgINVSCP4 == 0 and \
                MvToutCh2CHEX > SpToutCh2CHEX + 1 and CvVlvCh1CHEX > 0.95:
            for i in range(30,2,-1):
                FlgINVSCP4[i] = FlgINVSCP4[i-1]
            FlgINVSCP4[1] = 1

        elif  (MvGCh2CHEX <= 0.5) or \
                (FlgFlgINVSCP4 == 1 and MvToutCh2CHEX > SpToutCh2CHEX + 1 and CvVlvSCP4 > 0.95):
            for i in range(30,2,-1):
                FlgINVSCP4[i] = FlgINVSCP4[i-1]
            FlgINVSCP4[1] = -1
        else:
    ...
    # SCP1は動かさない
    global INVSCP,INVSCP10,CvINVSCP1,CvINVSCP10,Tv1INVSCP1
    INVSCP1 = 0
    INVSCP10 = 0
    CvINVSCP1 = 0
    CvINVSCP10 = 0
